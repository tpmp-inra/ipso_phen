...
%1 -m venv ipso_pip_env && .\ipso_pip_env\Scripts\activate.ps1 && python -m pip install --upgrade pip && pip install -r requirements.txt && .\ipso_pip_env\Scripts\deactivate.ps1
:missing_param
