...
class IptParamHolder(object):
    ...
    def build_output_path(self, file_prefix: str = "", salt: str = "") -> str:
        ...
        return os.path.join(
            ...
            self.build_output_filename(file_prefix=file_prefix, salt=salt),
        )
    ...
    def build_output_filename(self, file_prefix: str = "", salt: str = "") -> str:
