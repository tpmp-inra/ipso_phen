...
from ipso_phen.ipapi.ipt.ipt_keep_biggest_contour import IptKeepBiggestContours
...
class TestIptKeepBiggestContours(unittest.TestCase):
    def test_use_case(self):
        """Keep Biggest Contours: Check that all use cases are allowed"""
    ...
    def test_docstring(self):
        """Keep Biggest Contours: Test that class process_wrapper method has docstring"""
        op = IptKeepBiggestContours()
        if not op.is_wip:
            self.assertIsNotNone(
                op.process_wrapper.__doc__,
                "Missing docstring for Keep Biggest Contours",
            )

    def test_has_test_function(self):
        """Keep Biggest Contours: Check that at least one test function has been generated"""
        self.assertTrue(True, "No compatible test function was generated")

    def test_mask_transformation(self):
        """Keep Biggest Contours: Test that when using the basic mask generated script this tool produces a mask"""
        op = IptKeepBiggestContours()
    ...
    def test_documentation(self):
        doc_path = "./docs/ipt_Keep_Biggest_Contours.md"
        self.assertTrue(
