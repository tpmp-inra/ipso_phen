...
class TestIptOtsu(unittest.TestCase):
    def test_use_case(self):
        """Otsu: Check that all use cases are allowed"""
        op = IptOtsu()
    ...
    def test_docstring(self):
        """Otsu: Test that class process_wrapper method has docstring"""
        op = IptOtsu()
        if not op.is_wip:
    ...
    def test_has_test_function(self):
        """Otsu: Check that at least one test function has been generated"""
