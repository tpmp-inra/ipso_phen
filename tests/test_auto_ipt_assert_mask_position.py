...
class TestIptAssertMaskPosition(unittest.TestCase):
    def test_use_case(self):
        """Assert mask position: Check that all use cases are allowed"""
    ...
    def test_docstring(self):
        """Assert mask position: Test that class process_wrapper method has docstring"""
        op = IptAssertMaskPosition()
        if not op.is_wip:
    ...
    def test_has_test_function(self):
        """Assert mask position: Check that at least one test function has been generated"""
