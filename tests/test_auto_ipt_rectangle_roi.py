...
class TestIptRectangleRoi(unittest.TestCase):
    def test_use_case(self):
        """Rectangle ROI: Check that all use cases are allowed"""
        op = IptRectangleRoi()
    ...
    def test_docstring(self):
        """Rectangle ROI: Test that class process_wrapper method has docstring"""
        op = IptRectangleRoi()
        if not op.is_wip:
    ...
    def test_has_test_function(self):
        """Rectangle ROI: Check that at least one test function has been generated"""
        self.assertTrue(True, "No compatible test function was generated")

    def test_roi_out(self):
        """Rectangle ROI: Test that tool generates an ROI"""
        op = IptRectangleRoi()
