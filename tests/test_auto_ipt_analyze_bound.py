...
class TestIptAnalyzeBound(unittest.TestCase):
    def test_use_case(self):
        """Analyze bound: Check that all use cases are allowed"""
        op = IptAnalyzeBound()
    ...
    def test_docstring(self):
        """Analyze bound: Test that class process_wrapper method has docstring"""
        op = IptAnalyzeBound()
        if not op.is_wip:
            self.assertIsNotNone(
                op.process_wrapper.__doc__, "Missing docstring for Analyze bound"
            )

    def test_has_test_function(self):
        """Analyze bound: Check that at least one test function has been generated"""
        self.assertTrue(True, "No compatible test function was generated")

    def test_feature_out(self):
        """Analyze bound: "Test that when using the basic mask generated script this tool extracts features"""
        op = IptAnalyzeBound()
        ...
        self.assertNotEqual(
            ...
            second=0,
            msg="Analyze bound returned no data",
        )

    def test_documentation(self):
        doc_path = "./docs/ipt_Analyze_bound.md"
        self.assertTrue(
