...
from ip_base.ip_common import MaskData
...
class IptAnalyzeObject(IptBaseAnalyzer):
    ...
    def build_params(self):
        ...
        self.add_checkbox(
            desc='Straight bounding rectangle left', name='straight_bounding_rectangle_left', default_value=1
        )
        self.add_checkbox(
        ...
        self.add_checkbox(
            desc='Straight bounding rectangle top', name='straight_bounding_rectangle_top', default_value=1
        )
        self.add_checkbox(
        ...
        self.add_checkbox(
            desc='Rotated bounding rectangle cx', name='rotated_bounding_rectangle_cx', default_value=1
        )
        self.add_checkbox(
            desc='Rotated bounding rectangle cy', name='rotated_bounding_rectangle_cy', default_value=1
        )
        self.add_checkbox(
            desc='Rotated bounding rectangle width', name='rotated_bounding_rectangle_width', default_value=1
        )
        self.add_checkbox(
        ...
        self.add_checkbox(
            desc='Minimum enclosing circle cx', name='minimum_enclosing_circle_cx', default_value=1
        )
        self.add_checkbox(
            desc='Minimum enclosing circle cy', name='minimum_enclosing_circle_cy', default_value=1
        )
        self.add_checkbox(
            desc='Minimum enclosing circle radius', name='minimum_enclosing_circle_radius', default_value=1
        )
        ...
        self.add_checkbox(desc='Shape width standard deviation', name='shape_width_std', default_value=1)
        ...
        self.add_spin_box(
            name='line_width', desc='Draw line width (debug images)', default_value=4, minimum=1, maximum=100
        )
        self.add_spin_box(
            name='centroid_width',
