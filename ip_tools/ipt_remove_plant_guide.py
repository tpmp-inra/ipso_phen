...
class IptRemovePlantGuide(IptBase):
    ...
    def process_wrapper(self, **kwargs):
        ...
        try:
            if self.get_value_of("enabled") == 1:
                ...
                for line_number, line in enumerate(mask):
                    ...
                    if cur_ln_dt.nz_span == 0:
                        ...
                        break
                    elif investigate_lower_bound_ < cur_ln_dt.nz_span < investigate_upper_bound_:
                ...
                for line_number, line in enumerate(mask):
                    ...
                    if cur_ln_dt.nz_span == 0:
                        ...
                        # Look closely into it before deciding
                        guide_found_ = True
                        if cur_ln_dt.solidity < 0.4:  # There's probably a plant and a guide here
            ...
            res = False
            wrapper.error_holder.add_error(f"Remove plant guide FAILED, exception: {repr(e)}")
        else:
            pass
        finally:
            return res
