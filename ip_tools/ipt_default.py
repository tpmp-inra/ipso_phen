...
from ip_base.ip_common import TOOL_GROUP_DEFAULT_PROCESS_STR
...
class IptDefault(IptBaseAnalyzer):
    ...
    def build_params(self):
        ...
        self.add_channel_selector(default_value='h', hint='Select channel for pseudo color image')
    ...
    def process_wrapper(self, **kwargs):
        ...
        try:
            ...
            res = wrapper.process_image(
                ...
                horizontal_cleaning_method=self.get_value_of('horizontal_cleaning_method', 'mask_data')
            )
    ...
    def description(self):
        return 'Performs the default process associated with the experiment.\n' \
               'If no default process is available, all channels will be printed.'
