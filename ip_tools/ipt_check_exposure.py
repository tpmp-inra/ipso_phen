...
class IptExposureChecker(IptBaseAnalyzer):
    ...
    def build_params(self):
        ...
        self.add_color_selector(name='grey_zone_color', desc='Color for grey parts', default_value='fuchsia')

        self.add_separator(name='sep_1')
        self.add_source_selector(
            name='source_brightness', desc='Calculate source brightness on', default_value='source'
        )
        self.add_combobox(
            name='brg_calc',
        ...
        self.add_text_output(is_single_line=True, name='src_brightness', desc='Source brightness:')
    ...
    def process_wrapper(self, **kwargs):
        ...
        try:
            ...
            if text_overlay and (br_dict is not None):
                ...
                wrapper.store_image(self.result, f'exposure_{self.input_params_as_str()}', text_overlay=False)
