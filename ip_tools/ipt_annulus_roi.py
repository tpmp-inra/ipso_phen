...
from tools.regions import AnnulusRegion, EmptyRegion
...
class IptAnnulusRoi(IptBase):
    def build_params(self):
        ...
        self.add_spin_box(
            name="in_radius", desc="Inside radius", default_value=0, minimum=-10000, maximum=10000
        )
        self.add_button(
            name="draw_roi",
    ...
    def generate_roi(self, **kwargs):
        ...
        in_radius = self.get_value_of("in_radius")
