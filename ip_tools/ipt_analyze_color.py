...
class IptAnalyzeColor(IptBaseAnalyzer):
    ...
    def build_params(self):
        ...
        self.add_spin_box(name='hist_bins', desc='Histogram bins', default_value=256, minimum=2, maximum=256)
        self.add_spin_box(
            name='quantile_color',
        ...
        self.add_combobox(
            ...
            default_value='bw',
            values=dict(
                source='Source image', black='Black', white='White', silver='Silver', bw='Black and white'
            )
        )
    ...
    def process_wrapper(self, **kwargs):
        ...
        try:
            ...
            for k, v in channel_data.items():
                ...
                self.add_value(key=f'{seed_}_std_dev', value=tmp_tuple[1][0][0], force_add=add_mean_info)
                self.add_value(key=f'{seed_}_mean', value=tmp_tuple[0][0][0], force_add=add_std_dev_info)
