...
from ip_tools.ipt_keep_countours_near_rois import IptKeepCountoursNearRois
...
class TestIptKeepCountoursNearRois(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        self.assertIsNotNone(
            op.process_wrapper.__doc__, "Missing docstring for Keep countours near ROIs"
        )
    ...
    def test_documentation(self):
        ...
        self.assertTrue(
            ...
            "Missing documentation file for Keep countours near ROIs",
        )
