...
from ip_tools.ipt_analyze_bound import IptAnalyzeBound
...
class TestIptAnalyzeBound(unittest.TestCase):
    ...
    def test_feature_out(self):
        ...
        self.assertIsInstance(
            op, IptBaseAnalyzer, "Analyze bound must inherit from IptBaseAnalyzer"
        )
    ...
    def test_documentation(self):
        ...
        self.assertTrue(
            ...
            "Missing documentation file for Analyze bound",
        )
