...
from ipapi.ipt.ipt_van_vese import IptChanVese
...
class TestIptChanVese(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        if "(wip)" not in op.name.lower():
            self.assertIsNotNone(op.process_wrapper.__doc__, "Missing docstring for Chan Vese")
    ...
    def test_documentation(self):
        ...
        self.assertTrue(
            ...
            "Missing documentation file for Chan Vese",
        )
