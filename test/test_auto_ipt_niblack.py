...
from ipapi.ipt.ipt_niblack import IptNiblack
...
class TestIptNiblack(unittest.TestCase):
    ...
    def test_mask_generation(self):
        ...
        self.assertIsInstance(op.result, np.ndarray, "Empty result for Niblack binarization")
    ...
    def test_documentation(self):
        ...
        self.assertTrue(
            ...
            "Missing documentation file for Niblack binarization",
        )
