...
def main():
    ...
    wrapper.current_image = call_ipt(ipt_id="IptLinearTransformation",
                                     source=wrapper,
    ...
    # Build dynamic ROIs
    # __________________
    roi = call_ipt_func(ipt_id="IptHoughCircles",
                        source=wrapper,
    ...
    wrapper.current_image = call_ipt(ipt_id="IptExposureChecker",
                                     source=wrapper,
                                     overexposed_limit=180,
                                     over_color='blue_cabin',
                                     underexposed_limit=30,
    ...
    # Clean merged mask
    # _________________
    wrapper.mask = call_ipt(ipt_id="IptKeepLinkedContours",
                            source=wrapper,
    ...
    current_data = call_ipt(ipt_id="IptAnalyseObservation",
                            source=wrapper,
                            split_plant_name=1,
                            new_column_names='species,id,gen,treatment')
    ...
    wrapper.mosaic_data = None
    wrapper.print_mosaic()
