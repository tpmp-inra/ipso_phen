...
from ipt.ipt_threshold_triangle import IptThresholdTriangle
...
class TestIptThresholdTriangle(unittest.TestCase):
    ...
    def test_mask_generation(self):
        ...
        self.assertIsInstance(op.result, np.ndarray, "Empty result for Triangle threshold")
    ...
    def test_documentation(self):
        ...
        self.assertTrue(
            ...
            "Missing documentation file for Triangle threshold",
        )
