...
from ipapi.ipt.ipt_clahe import IptClahe
...
class TestIptClahe(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        if "(wip)" not in op.name.lower():
            self.assertIsNotNone(op.process_wrapper.__doc__, "Missing docstring for CLAHE")
    ...
    def test_documentation(self):
        ...
        self.assertTrue(
            ...
            "Missing documentation file for CLAHE",
        )
